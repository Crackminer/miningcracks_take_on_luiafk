...
{
    public class EmeraldCorn : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Emerald GemSapling");
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			bool growSuccess = WorldGen.GrowTreeWithSettings(i, j, GrowTreeSettings.Profiles.GemTree_Emerald);
