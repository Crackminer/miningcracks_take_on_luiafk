...
{
    public class DiamondCorn : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Diamond GemSapling");
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			bool growSuccess = WorldGen.GrowTreeWithSettings(i, j, GrowTreeSettings.Profiles.GemTree_Diamond);
