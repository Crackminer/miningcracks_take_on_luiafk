...
{
    public class TopazCorn : ModTile
    {
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Topaz GemSapling");
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			bool growSuccess = WorldGen.GrowTreeWithSettings(i, j, GrowTreeSettings.Profiles.GemTree_Topaz);
