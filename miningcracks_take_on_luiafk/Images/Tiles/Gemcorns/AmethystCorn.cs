...
{
    public class AmethystCorn : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Amethyst GemSapling");
		...
		public override void RandomUpdate(int i, int j)
		{
			...
			bool growSuccess = WorldGen.GrowTreeWithSettings(i, j, GrowTreeSettings.Profiles.GemTree_Amethyst);
