...
{
    public class AmberCorn : ModTile
    {
		public override void SetStaticDefaults()
		{
			...
			name.SetDefault("Amber GemSapling");
			...
			TileMaterials.SetForTileId(Type, TileMaterials.GetByTileId(TileID.Stone)); // Make this tile interact with golf balls in the same way other plants do
        ...
        public override void RandomUpdate(int i, int j)
		{
			...
			bool growSuccess = WorldGen.GrowTreeWithSettings(i, j, GrowTreeSettings.Profiles.GemTree_Amber);
