...
{
	public class DefendersForgeProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Flying Defender's Forge");
		}
		...
		public override void PostAI()
		{
			if (Main.netMode != 2)
			{
				...
				ProjAIs.BankAI(base.Projectile, base.Mod.Find<ModItem>("DefendersForge").Type, -4, ref modPlayer.defenders, player, modPlayer);
			}
		}
	}
}
