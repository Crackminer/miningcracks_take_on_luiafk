...
{
	public class PiggySafe : ModItem
	{
		public override void SetStaticDefaults()
		{
			base.DisplayName.SetDefault("Mobile PiggySafe Merchant");
			base.Tooltip.SetDefault("Summons a floating Piggy Bank and Safe.\nSummons a Fairy that will buy and sell goods.\nSmart cursor disabled while using banks.");
		...
		{
			CreateRecipe().AddIngredient(null, "PiggyBank").AddIngredient(null, "Safe").AddIngredient(null, "MobileMerchant")
				.AddTile(18)
				.Register();
		}
	}
