...
namespace miningcracks_take_on_luiafk.NPCs
{
    ...
    public class TravellingMerchant : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.Happiness
                .SetNPCAffection(NPCID.BestiaryGirl, AffectionLevel.Love) //Because he is in love with her
                .SetNPCAffection(NPCID.Merchant, AffectionLevel.Like) //Because both love to sell things pricy
                .SetNPCAffection(NPCID.TaxCollector, AffectionLevel.Hate) //Because he takes his fortune... How could he like that?!
                .SetBiomeAffection<ForestBiome>(AffectionLevel.Love) //Because forest is classic, and bring lots of customers
                .SetBiomeAffection<DesertBiome>(AffectionLevel.Like) //Because it's cool, he likes the scenery
                .SetBiomeAffection<UndergroundBiome>(AffectionLevel.Hate) //Because underground, there's nothing... And it's dangerous for a merchant like him!
            ;
